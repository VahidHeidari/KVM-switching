...
#define SWIGTYPE_p_std__vectorT_std__string_std__allocatorT_std__string_t_t swig_types[5]
...
SWIGEXPORT void Init_xkb(void) {
  ...
  cGC_VALUE.klass = rb_define_class_under(mXkb, "GC_VALUE", rb_cObject);
  ...
  cConstIterator.klass = rb_define_class_under(mXkb, "ConstIterator", rb_cObject);
  ...
  cIterator.klass = rb_define_class_under(mXkb, "Iterator", ((swig_class *) SWIGTYPE_p_swig__ConstIterator->clientdata)->klass);
  ...
  cXKeyboard.klass = rb_define_class_under(mXkb, "XKeyboard", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_XKeyboard, (void *) &cXKeyboard);
  rb_define_alloc_func(cXKeyboard.klass, _wrap_XKeyboard_allocate);
  rb_define_method(cXKeyboard.klass, "initialize", VALUEFUNC(_wrap_new_XKeyboard), -1);
  rb_define_method(cXKeyboard.klass, "group_count", VALUEFUNC(_wrap_XKeyboard_group_count), -1);
  rb_define_method(cXKeyboard.klass, "group_names", VALUEFUNC(_wrap_XKeyboard_group_names), -1);
  rb_define_method(cXKeyboard.klass, "group_symbols", VALUEFUNC(_wrap_XKeyboard_group_symbols), -1);
  rb_define_method(cXKeyboard.klass, "current_group_num", VALUEFUNC(_wrap_XKeyboard_current_group_num), -1);
  rb_define_method(cXKeyboard.klass, "current_group_name", VALUEFUNC(_wrap_XKeyboard_current_group_name), -1);
  rb_define_method(cXKeyboard.klass, "current_group_symbol", VALUEFUNC(_wrap_XKeyboard_current_group_symbol), -1);
  rb_define_method(cXKeyboard.klass, "set_group_by_num", VALUEFUNC(_wrap_XKeyboard_set_group_by_num), -1);
  rb_define_method(cXKeyboard.klass, "change_group", VALUEFUNC(_wrap_XKeyboard_change_group), -1);
  cXKeyboard.mark = 0;
  cXKeyboard.destroy = (void (*)(void *)) free_XKeyboard;
  cXKeyboard.trackObjects = 0;
  
  cXkbSymbolParser.klass = rb_define_class_under(mXkb, "XkbSymbolParser", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_XkbSymbolParser, (void *) &cXkbSymbolParser);
  rb_define_alloc_func(cXkbSymbolParser.klass, _wrap_XkbSymbolParser_allocate);
  rb_define_method(cXkbSymbolParser.klass, "initialize", VALUEFUNC(_wrap_new_XkbSymbolParser), -1);
  rb_define_method(cXkbSymbolParser.klass, "parse", VALUEFUNC(_wrap_XkbSymbolParser_parse), -1);
  cXkbSymbolParser.mark = 0;
  cXkbSymbolParser.destroy = (void (*)(void *)) free_XkbSymbolParser;
  cXkbSymbolParser.trackObjects = 0;
